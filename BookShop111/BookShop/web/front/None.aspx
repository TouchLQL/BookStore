<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="None.aspx.cs" Inherits="BookShop.web.front.None" %>
...
<script type="text/javascript" charset="utf-8" src="../js/none.js"></script>
...
<body>
    ...
    <div id="bookPictures">
      ...
      <tr>
    	<td>
    	<img src="../images/book7.png"  alt="等待更新" class="img2"/>
    	<p class="tishi">亲 ， 等 待 更 新 哦 ！！！     =。=</p>
    	</td>
      </tr>
      </table>
      </div>
